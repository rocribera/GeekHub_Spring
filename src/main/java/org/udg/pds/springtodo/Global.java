...
public class Global {
    ...
    private void initData() {
        ...
        userService.updateProfile(user.getId(),"","A user like the others","prova1.jpg", true);
        userService.updateProfile(user2.getId(),"","A user like the others","prova1.jpg", true);
